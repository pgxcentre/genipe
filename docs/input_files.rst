...
Multiple input files are required for :py:mod:`genip` in order to perform the
...
required files, see the :ref:`genip-tut-input-files` section of the tutorial.

Here is a typical project directory structure. Again, refer to the
:ref:`genip-tut-input-files` section of the tutorial for more information.
