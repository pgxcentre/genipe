...
.. code-block:: bash
   ...
   mkdir -p $HOME/genip_tutorial/survival
...
.. code-block:: bash
   ...
   cd $HOME/genip_tutorial/survival

   wget http://pgxcentre.github.io/genip/_static/tutorial/phenotypes_survival.txt.bz2
...
.. code-block:: console
   ...
   model. This script is part of the 'genip' package, version 1.1.0).
...
The survival analysis results from :py:mod:`genip` and *JMP Genomics* were
...
.. figure:: ../_static/images/Survival_Diff_Prob0.png
   :align: center
   :width: 100%
   :alt: Survival analysis comparison between genip and JMP Genomics

.. note::

   The sign of the coefficients might be different when comparing
   :py:mod:`genip` to *GMP Genomics*, since :py:mod:`genip` computes the
