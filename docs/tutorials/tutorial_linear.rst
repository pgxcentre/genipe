...
.. code-block:: bash
   ...
   mkdir -p $HOME/genip_tutorial/linear
...
.. code-block:: bash
   ...
   cd $HOME/genip_tutorial/linear

   wget http://pgxcentre.github.io/genip/_static/tutorial/phenotypes_linear.txt.bz2
...
.. code-block:: console
   ...
   script is part of the 'genip' package, version 1.1.0).
...
The linear regression results from :py:mod:`genip` and *Plink* were compared
...
.. figure:: ../_static/images/Linear_Diff_Prob0.png
   :align: center
   :width: 100%
   :alt: Linear regression comparison between genip and Plink (probability of 0)
...
.. note::
   ...
   .. figure:: ../_static/images/Linear_Diff.png
      :align: center
      :width: 100%
      :alt: Linear regression comparison between genip and Plink
