...
class TestImpute2Merger(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Creating three small input files
        self.filenames = [
        ...
        # Creating the files
        for filename, content, s_content in zip(self.filenames, file_content,
                                                summary_content):
        ...
        prefix1 = os.path.join(self.output_dir.name, "genip_results_1")
        args = [
            "--chr", "1",
            "--probability", "0.9",
            "--completion", "0.98",
        ...
        prefix2 = os.path.join(self.output_dir.name, "genip_results_2")
        args = [
            "--chr", "1",
            "--probability", "0.8",
            "--completion", "0.98",
        ...
        # Executing the script for the second time with different values
        prefix3 = os.path.join(self.output_dir.name, "genip_results_3")
        args = [
            "--chr", "1",
            "--probability", "0.9",
            "--completion", "0.6",
