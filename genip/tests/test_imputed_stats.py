...
class TestImputedStatsSkat(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.tmp_dir = TemporaryDirectory(prefix="genip_test_")
    ...
    def setup_skat_files(out_directory):
        """Parses the SKAT example files into the format expected by genip."""
        ...
        # We also add the outcomes to this (genip uses a single file for both
