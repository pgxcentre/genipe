...
def main():
    ...
    desc = ("Execute the genome-wide imputation pipeline. This script is part "
            "of the 'genip' package, version {}.".format(__version__))
    ...
    try:
        ...
        log_file = os.path.join(args.out_dir, "genip.log")
        logging.basicConfig(
...
def phase_markers(prefix, o_prefix, db_name, options):
    ...
    chromosome number (e.g. ``genip/chr{chrom}/chr{chrom}.final`` will be
    replaced by ``genip/chr1/chr1.final``).
...
def check_args(args):
    ...
    If an option is invalid, a :py:class:`genip.error.ProgramError` is raised.
...
def parse_args(parser):
    ...
    group.add_argument(
        ...
        type=str,
        metavar="AUTHOR",
        default="Automatically generated by genip",
