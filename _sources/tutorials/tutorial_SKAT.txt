...
association of sets of rare and common variants. In :py:mod:`gwip`, we provide
...
This file is generated by :py:mod:`gwip` and has the ``.sample`` extension. It
...
The `.good_sites` file is also generated by :py:mod:`gwip`. It contains a
...
2. The `Impute2` file as previously described. This contains the probability
   for every allele of every variant. It is generated by :py:mod:`gwip`.
3. The `sample` contained the sample identifiers with an ordering consistent
   with the `Impute2` file. It was generated by :py:mod:`gwip`.
...
8. A list of variants to keep for the analysis is provided here. A good choice
   would be to simply use the `.good_sites` file generated by py:mod:`gwip`,
...
You can also verify the `my_skat_analysis.log` file to see if :py:mod:`gwip` or
`SKAT` generated any warnings.
...
:py:mod:`gwip` source and modify the
`run_skat.R <https://github.com/pgxcentre/gwip/blob/master/gwip/script_templates/run_skat.R>`_
file. This is a template rendered and launched by :py:mod:`gwip` to conduct the
analysis by using the regular R SKAT package. It is easy to extend this file to
customize your analysis or to write new ones.
